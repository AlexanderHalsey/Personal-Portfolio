        ...
        React.createElement(AppBar, { position: "static" },
            React.createElement(Container, { maxWidth: "xl" },
                React.createElement(Toolbar, { disableGutters: true },
                    React.createElement(Typography, { variant: "h6", noWrap: true, component: "div", sx: { mr: 2, display: { xs: 'none', md: 'flex' } } }, "LOGO"),
                    React.createElement(Box, { sx: { flexGrow: 1, display: { xs: 'flex', md: 'none' } } },
                        ...
                        React.createElement(Menu, { id: "menu-appbar", anchorEl: anchorElNav, anchorOrigin: {
                            ...
                            } }, pages.map(function (page) { return (React.createElement(MenuItem, { key: page, onClick: handleCloseNavMenu },
                            React.createElement(Typography, { textAlign: "center" }, page))); }))),
                    React.createElement(Typography, { variant: "h6", noWrap: true, component: "div", sx: { flexGrow: 1, display: { xs: 'flex', md: 'none' } } }, "LOGO"),
                    React.createElement(Box, { sx: { flexGrow: 1, display: { xs: 'none', md: 'flex' } } }, pages.map(function (page) { return (React.createElement(Button, { key: page, onClick: handleCloseNavMenu, sx: { my: 2, color: 'white', display: 'block' } }, page)); })))))));
};
